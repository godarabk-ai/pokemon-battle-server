/* RENDER FX - Visual effects, particles, projectiles */
...
const RenderFX = {
    ...
    triggerTypeAtmosphere(moveType) {
        ...
        overlay.classList.remove(
            'fx-water', 'fx-grass', 'fx-fire', 'fx-electric', 'fx-ice', 'fx-poison',
            'fx-psychic', 'fx-ghost', 'fx-rock', 'fx-ground', 'fx-fairy', 'fx-steel',
            'fx-dragon', 'fx-dark', 'fx-bug', 'fx-flying', 'fx-normal', 'fx-fighting'
        );
