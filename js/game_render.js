...
const RenderEngine = {
            ...
            if (pct <= 0) {
                ...
                if (
                    ...
                    if (isOnline && window.OnlineGame) {
                        ...
                        this.log(`${n} ran out of time!`, 'text-red-400');
                    } else {
    ...
    async spawnPokemon(playerKey, mon, isEvolution = false) {
        ...
        spriteBox.classList.remove('anim-faint', 'ko-flash', 'ko-grey', 'anim-charge', 'anim-windup', 'anim-enter-left', 'anim-enter-right', 'anim-enter-left-back', 'anim-enter-right-back', 'anim-warp');
